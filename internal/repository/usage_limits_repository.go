...
func CreateDefaultUsageLimits() error {
	// Define new default plans according to the updated schema
	defaultPlans := []model.UsageLimits{
		{
			...
			QuestionBanks:           1,
			Questions:               30,
			AssignmentExportsPerDay: 5,
			AI: model.AILimits{
				IndependentAgent:   10,
				LumenAgent:         10,
				RAGAgent:           5,
				RAGDocumentUploads: 1,
			},
			IsActive: true,
		},
		{
			PlanName:                "private_tutor",
			Teachers:                5,
			Classrooms:              2,
			...
			AI: model.AILimits{
				...
				LumenAgent:         100,
				RAGAgent:           100,
				RAGDocumentUploads: 15,
			},
			IsActive: true,
		},
		{
			PlanName:                "multi_classroom",
			Teachers:                10,
			Classrooms:              5,
